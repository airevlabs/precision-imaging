# Follow-up and Surveillance Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "follow up ultrasound," "surveillance scan Downers Grove," "monitoring ultrasound Chicago"  
...
- **H1:** `Follow-up & Surveillance Ultrasound | Precision Imaging`
- **Subhead:** `Monitoring known conditions & treatment response`
...
- **Bullet list of organs:** Any previously identified area requiring monitoring
...
- **Bullet list:** Tumor size changes, cyst resolution, vascular stent patency, post-surgical healing
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - Follow previous exam preparation instructions
- **Timeline:** "Arrive 15 mins early."

## 5. Exam Process & Duration
- **H2:** `What Happens During the Exam`
- **Steps:** Same protocol as original exam → comparison measurements → progress documentation
- **Duration:** `15-45 minutes`
- **Comfort:** "Familiar procedure."
...
- **5 questions** (accordion or bullets):
  ...
  - How long does it take? *(15-45 minutes)*
