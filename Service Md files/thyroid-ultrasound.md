# Thyroid Ultrasound Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "thyroid ultrasound near me," "thyroid scan Downers Grove," "thyroid nodule Chicago suburbs"  
...
- **H1:** `Thyroid Ultrasound Downers Grove | Precision Imaging`
- **Subhead:** `Detailed imaging of thyroid gland & neck structures`
- **Short benefit:** `Transparent pricing. Fast scheduling. Results to your doctor.`
- **Primary CTA:** `Book Grove Ultrasound` → website booking link
- **Secondary CTA:** `Contact Us` → website contact form

## 2. What the Exam Shows
- **H2:** `What Does a Grove Ultrasound Examine?`
- **Bullet list of organs:** Thyroid gland, parathyroid glands, lymph nodes, neck blood vessels
...
- **Bullet list:** Thyroid nodules, goiter, cysts, Hashimotos thyroiditis, thyroid cancer, lymph node abnormalities
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - No fasting required, wear comfortable clothing with loose neckline, avoid lotions/powders on neck/shoulders, remove necklaces/jewelry
- **Timeline:** "Arrive 15 mins early."

## 5. Exam Process & Duration
- **H2:** `What Happens During the Exam`
- **Steps:** Neck exposed → gel applied to throat area → transducer moved along neck → detailed thyroid measurements → clean up
- **Duration:** `20-40 minutes`
- **Comfort:** "Painless procedure."

## 6. Why Precision Imaging
- **H2:** `Why Get Your Grove Ultrasound Here`
...
- **5 questions** (accordion or bullets):
  ...
  - How long does it take? *(20-40 minutes)*
