# Kidney and Bladder Ultrasound Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "kidney ultrasound near me," "bladder scan Downers Grove," "kidney stone ultrasound Chicago"  
...
- **H1:** `Kidney & Bladder Ultrasound | Precision Imaging Downers Grove`
- **Subhead:** `Comprehensive urinary tract imaging`
- **Short benefit:** `Transparent pricing. Fast scheduling. Results to your doctor.`
- **Primary CTA:** `Book Ultrasound Ultrasound` → website booking link
- **Secondary CTA:** `Contact Us` → website contact form

## 2. What the Exam Shows
- **H2:** `What Does a Ultrasound Ultrasound Examine?`
- **Bullet list of organs:** Both kidneys, ureters, bladder, prostate
...
- **Bullet list:** Kidney stones, cysts, hydronephrosis, bladder wall thickening, post-void residual
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - Full bladder (drink 32oz water 1 hour before)
- **Timeline:** "Arrive 15 mins early."

## 5. Exam Process & Duration
- **H2:** `What Happens During the Exam`
- **Steps:** Full bladder confirmed → kidneys examined → bladder volume measured before/after voiding
- **Duration:** `20-35 minutes`
- **Comfort:** "Full bladder may cause discomfort."

## 6. Why Precision Imaging
- **H2:** `Why Get Your Ultrasound Ultrasound Here`
...
- **5 questions** (accordion or bullets):
  ...
  - How long does it take? *(20-35 minutes)*
