# Vascular Ultrasound Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "vascular ultrasound near me," "carotid doppler Downers Grove," "leg vein ultrasound"  
...
- **H1:** `Vascular Ultrasound & Doppler | Precision Imaging Downers Grove`
- **Subhead:** `Blood flow assessment for arteries & veins`
- **Short benefit:** `Transparent pricing. Fast scheduling. Results to your doctor.`
- **Primary CTA:** `Book Vascular Ultrasound` → website booking link
- **Secondary CTA:** `Contact Us` → website contact form

## 2. What the Exam Shows
- **H2:** `What Does a Vascular Ultrasound Examine?`
- **Bullet list of organs:** Carotid arteries, leg veins, abdominal aorta, peripheral arteries
...
- **Bullet list:** Blockages, blood clots, narrowing, poor circulation, aneurysms
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - No special prep, wear loose clothing, avoid lotions
...
- **H2:** `Why Get Your Vascular Ultrasound Here`
