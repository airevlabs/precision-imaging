# Pelvic Ultrasound Service Page Template (Females)

## Page Requirements
**SEO Keywords to weave in naturally:** "pelvic ultrasound near me," "pelvic scan Downers Grove," "women's ultrasound Chicago suburbs," "ovarian cyst ultrasound," "uterus ultrasound"  
**Length:** 800-1200 words total  
**Images:** Ultrasound machine, gel transducer, sample pelvic scan (anonymized)  
**Schema:** MedicalService + FAQPage

## 1. Hero Section (Above the Fold)
- **H1:** `Pelvic Ultrasound Downers Grove | Women's Health | Precision Imaging`
- **Subhead:** `Safe imaging of uterus, ovaries, fallopian tubes & bladder`
- **Short benefit:** `Transparent pricing. Fast scheduling. Results to your doctor.`
- **Primary CTA:** `Book Pelvic Ultrasound` → website booking link
- **Secondary CTA:** `Contact Us` → website contact form

## 2. What the Exam Shows
- **H2:** `What Does a Pelvic Ultrasound Examine?`
- **Bullet list of organs:** Uterus, ovaries, fallopian tubes, endometrium, bladder, pelvic structures
...
- **Bullet list:** Fibroids, ovarian cysts, endometrial thickening, ectopic pregnancy, polyps, pelvic masses
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - Drink 32oz water 1 hour before exam (full bladder required)
  - No fasting necessary
  - Wear comfortable clothing (bottoms easily removable)
  - Empty bowels if possible
- **Timeline:** "Arrive 15 mins early."

## 5. Exam Process & Duration
- **H2:** `What Happens During the Exam`
- **Steps:** Full bladder confirmed → gel applied to lower abdomen → transducer moved over pelvis → images captured → clean up
- **Duration:** `15-30 minutes`
- **Comfort:** "Painless. Full bladder may cause mild discomfort."

## 6. Why Precision Imaging
- **H2:** `Why Get Your Pelvic Ultrasound Here`
...
- **5 questions** (accordion or bullets):
  - Do I need a full bladder? *(Yes, drink 32oz water 1 hour before)*
  - How long does it take? *(15-30 min)*
