# Pediatric Imaging Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "pediatric ultrasound near me," "children ultrasound Downers Grove," "baby ultrasound Chicago suburbs"  
...
- **H1:** `Pediatric Ultrasound Downers Grove | Precision Imaging`
- **Subhead:** `Gentle imaging for infants, children & teens`
- **Short benefit:** `Transparent pricing. Fast scheduling. Results to your doctor.`
- **Primary CTA:** `Book Pediatric Ultrasound` → website booking link
- **Secondary CTA:** `Contact Us` → website contact form

## 2. What the Exam Shows
- **H2:** `What Does a Pediatric Ultrasound Examine?`
- **Bullet list of organs:** Abdomen, hips, head, kidneys, bladder, thyroid, hips
...
- **Bullet list:** Hip dysplasia, kidney abnormalities, abdominal masses, pyloric stenosis, appendicitis
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - Follow age-appropriate fasting (infants usually no fasting), bring comfort items, dress child in loose clothing, parents stay
...
- **Comfort:** "Child-friendly. Parent stays throughout."

## 6. Why Precision Imaging
- **H2:** `Why Get Your Pediatric Ultrasound Here`
