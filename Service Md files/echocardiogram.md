# Echocardiogram Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "echocardiogram near me," "heart ultrasound Downers Grove," "echo Chicago suburbs"  
...
- **H1:** `Echocardiogram | Precision Imaging Downers Grove`
- **Subhead:** `Detailed heart structure & function assessment`
- **Short benefit:** `Transparent pricing. Fast scheduling. Results to your doctor.`
- **Primary CTA:** `Book Echocardiogram Ultrasound` → website booking link
- **Secondary CTA:** `Contact Us` → website contact form

## 2. What the Exam Shows
- **H2:** `What Does a Echocardiogram Ultrasound Examine?`
- **Bullet list of organs:** Heart chambers, valves, walls, pericardium, great vessels
...
- **Bullet list:** Valve problems, wall motion abnormalities, ejection fraction, clots, pericardial effusion
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - No fasting, avoid caffeine 2 hours prior
- **Timeline:** "Arrive 15 mins early."

## 5. Exam Process & Duration
- **H2:** `What Happens During the Exam`
- **Steps:** Multiple positions → gel on chest → detailed heart imaging from multiple angles → Doppler flow assessment
- **Duration:** `45 minutes to 1 hour`
- **Comfort:** "Painless. May need position changes."

## 6. Why Precision Imaging
- **H2:** `Why Get Your Echocardiogram Ultrasound Here`
...
- **5 questions** (accordion or bullets):
  ...
  - How long does it take? *(45 minutes to 1 hour)*
