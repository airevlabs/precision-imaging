# Wellness and Preventative Service Page Template

## Page Requirements
**SEO Keywords to weave in naturally:** "preventative ultrasound," "wellness screening Downers Grove," "proactive imaging Chicago"  
...
- **H1:** `Wellness & Preventative Ultrasound | Precision Imaging`
- **Subhead:** `Proactive screening for peace of mind (not diagnostic)`
...
- **Bullet list of organs:** Abdomen, thyroid, carotid arteries, AAA screening (age-appropriate)
...
- **Bullet list:** Early detection of silent conditions
- **Reassuring note:** "Early detection allows for timely treatment."

## 4. Preparation Instructions
- **H2:** `How to Prepare`
- **Clear bullets:** 
  - Screening-specific preparation
- **Timeline:** "Arrive 15 mins early."

## 5. Exam Process & Duration
- **H2:** `What Happens During the Exam`
- **Steps:** Comprehensive baseline screening → images provided on CD → radiology report requires physician order
- **Duration:** `30-60 minutes`
- **Comfort:** "Comprehensive but comfortable screening."
